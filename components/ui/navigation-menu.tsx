...
const navigationMenuTriggerStyle = cva(
    "group inline-flex h-9 w-max items-center justify-center disabled:pointer-events-none disabled:opacity-50 dark:ring-neutral-950/20 dark:outline-ring/40 outline-ring/50 transition-[color,box-shadow] focus-visible:ring-4 focus-visible:outline-1 hover:text-red-500 hover:scale-100 duration-300 easy-in-out"
)
...
function NavigationMenuViewport({
    ...
    return (
        <div
            className={cn(
                "absolute top-full left-13 isolate z-50 flex justify-center"
            )}
        >
